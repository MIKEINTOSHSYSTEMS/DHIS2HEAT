...
overflow-x: auto;overflow-y: auto; height: 350px; background: #ffffd4;}")),
    ...
    observeEvent(input$mWideLongyes, {
        ...
        #vmy$mydata <- melt(data = as.data.frame(readRDS("fetched_data/main.rds")), id.vars = mselected[1], variable.name = "Var_Name", value.name = "Value", na.rm = TRUE, factorsAsStrings = TRUE)
